...
public class Addition extends Operation {
    public Addition(MatrixInputter leftMatrixInputter, MatrixInputter rightMatrixInputter, Matrix matrix, String operation) {
        super(leftMatrixInputter, rightMatrixInputter, matrix, operation);
    }

    @Override
    public Label[][] mergeMatricesByOperation() {
